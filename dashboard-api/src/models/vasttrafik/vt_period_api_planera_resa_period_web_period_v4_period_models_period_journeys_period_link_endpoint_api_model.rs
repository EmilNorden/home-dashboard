...
/// VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodJourneysPeriodLinkEndpointApiModel : Information about an endpoint on an access link.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodJourneysPeriodLinkEndpointApiModel {
...
impl VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodJourneysPeriodLinkEndpointApiModel {
    /// Information about an endpoint on an access link.
    pub fn new(
        name: String,
        location_type: crate::models::VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodLocationType,
        planned_time: String,
    ) -> VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodJourneysPeriodLinkEndpointApiModel
    {
        VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodJourneysPeriodLinkEndpointApiModel {
            gid: None,
            name,
