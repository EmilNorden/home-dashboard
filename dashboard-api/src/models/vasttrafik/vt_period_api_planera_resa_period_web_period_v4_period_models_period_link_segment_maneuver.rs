...
/// VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodLinkSegmentManeuver : Specifies a maneuver to be executed for a link segment.

/// Specifies a maneuver to be executed for a link segment.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodLinkSegmentManeuver {
    #[serde(rename = "none")]
    None,
    #[serde(rename = "from")]
    From,
...
impl ToString for VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodLinkSegmentManeuver {
...
impl Default for VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodLinkSegmentManeuver {
    fn default() -> VtPeriodApiPlaneraResaPeriodWebPeriodV4PeriodModelsPeriodLinkSegmentManeuver {
        Self::None
    }
}
